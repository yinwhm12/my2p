...
func TestContextDatabases(t *testing.T) {
	...
	//ctx := &ServiceContext{config: &Config{Name: "unit-test", DataDir: dir}}//todo new
	//db, err := ctx.OpenDatabase("persistent", 0, 0) //todo new
	//if err != nil {
	...
	//ctx = &ServiceContext{config: &Config{DataDir: ""}} //todo new
	//db, err = ctx.OpenDatabase("ephemeral", 0, 0) //todo new
	//if err != nil {
